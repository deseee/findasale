...
| 200 | ✅ | ✅ | ✅ | 📋 | ✅ | ⬜ | Pending Chrome QA | Shopper Public Profiles | SHO | FREE | Human QA | Shipped S344. profileSlug/purchasesVisible/collectorTitle + migration. GET /shoppers/:id, /shoppers/[id].tsx. |
|  64 | ✅ | ✅ | ✅ | ✅ | ✅ | ⬜ | Pending Chrome QA | Save/Wishlist/My Collections | SHO | FREE | Chrome QA: verify nav unified, favorites tab removed, redirects work | Shipped S344 — nav unified, My Collections label on 6 surfaces |
...
|  13 | ✅ | ✅ | ✅ | 📋 | ✅ | ⬜ FIXED S346 | Chrome-verified S493 | TEAMS Workspace | ORG | TEAMS | Chrome QA S493: workspace chat ✅, task creation ✅, team member list renders. Member lookup fix (S346) confirmed working. | Multi-user workspace, role management |
...
| 233 | NA | ✅ | ✅ | ✅ | ✅ | ⬜ | Chrome-verified S515 ✅ | Organizer Efficiency Coaching Widget | ORG | ALL | Chrome QA: verify stats + tips render on dashboard States 2 & 3 | EfficiencyCoachingWidget.tsx. GET /api/organizers/efficiency-stats. Photo-to-publish time, sell-through %, percentile rank, tips. |
| 234 | NA | NA | ✅ | ✅ | ⚠️ | ⬜ | Chrome-verified S515 ⚠️ P1: shows totalLifetime revenue not sale-specific revenue | Post-Sale Momentum Prompt | ORG | ALL | Chrome QA: verify card appears in dashboard State 3 with revenue/items/sell-through | PostSaleMomentumCard.tsx on dashboard State 3. "Settle This Sale" + "Start Next Sale" CTAs. |
