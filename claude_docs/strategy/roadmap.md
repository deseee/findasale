...
**Last Updated:** 2026-04-03 (v96 — S390b: RSVP XP, trail completion XP, legendary-first access gating, Explorer's Guild onboarding card, TEAMS solo copy, share moments ×3, Hunt Pass Option A cosmetic, Brand Follow #87 fixed, Haul Posts #88 audited DEAD. #267–#277 new entries.)
**Last Updated:** 2026-04-03 (v95 — S390: S389 alignment doc fully implemented. Hunt Pass 1.5x fix + XP matrix (#259). À la carte pricing page visibility (#260). Treasure Hunt XP rank multiplier Ranger+ (#261). Tier restructure batch ops/badge/link click stats→SIMPLE (#262). Organizer nav Insights+Branding (#263). Org dashboard Tier Progress widget (#264). Shopper dashboard gamification enhancements (#265). Collector Passport nav rename (#266). Entry #7 fully shipped with /shopper/referrals UI.)
...
| 276 | ✅ | ✅ | ✅ | ✅ | ⬜ | ⬜ | Shipped S390b — Pending Chrome QA | Brand Follow (#87) — FIXED | SHO | FREE | Chrome QA: shopper dashboard Brands tab → BrandFollowManager renders, follow/unfollow works | Audit: schema ✅, routes ✅, component ✅, but never mounted in dashboard Brands tab. Fixed: 5 lines added to shopper/dashboard.tsx. |
| 277 | ✅ | ✅ | ⬜ | ⬜ | NA | NA | DEAD — Backlog | Haul Posts (#88) | SHO | FREE | Backlog: build /shopper/haul-posts listing + creation pages + nav (est. 8–12h) | Audit: schema ✅, routes /api/ugc-photos ✅, HaulPostCard.tsx ✅, useHaulPosts ✅. Missing: listing/creation pages (only /haul/coming-soon). No nav link. |
...
| 133 | ✅ | ✅ | ✅ | 📋 | ⬜ | ⬜ | Shipped S389 — Pending Chrome QA | Hunt Pass Subscription Redesign | SHO | PAID_ADDON | Chrome QA: verify 1.5x XP multiplier on purchase; ⚠️ hunt-pass.tsx page STILL SAYS "2x XP" — fix copy before beta | S389: 1.5x multiplier wired in stripeController + auctionJob. Page copy mismatch: page says 2x, code enforces 1.5x — HIGH PRIORITY FIX. |
...
| 212 | ✅ | ✅ | ✅ | 📋 | ✅ | ⬜ | Chrome-verified S356 | Leaderboard | SHO | FREE | Chrome-verified S356 (user12): /shopper/leaderboard loads. /api/xp/leaderboard returns 200 empty array (no XP data in test env yet). Correct empty state shown. WORKS. | FIXED S347 |
