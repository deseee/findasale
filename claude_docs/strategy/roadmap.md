...
**Last Updated:** 2026-04-14 (v105 — S449–S462: Explorer Guild rank perks + phase 2 complete (S449–S450); Dashboard polish + action buttons + QR inline (S451); eBay+Stripe go-live prep (S452); Hunt Pass→Stripe recurring subscription (S454); eBay inventory imports full-stack + OAuth/cart fixes (S455–S456); Pull to Sale fixed + GetItem enrichment (S457–S459); Post-sale eBay workflow + shipping classification (S460); eBay 6-round push fixes (S461); eBay listing data parity A+B+C (S462). Patrick human QA: S450 rank+character sheet ✅, S451 dashboard layout ✅, S454 Hunt Pass Stripe ✅, S456 eBay import (86 items, photos) ✅, S461 Contigo travel mug pushed ✅)
