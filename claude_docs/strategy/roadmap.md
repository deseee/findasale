...
|  25 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Shipped S456–S464 — Pending Chrome QA full suite | Organizer Persistent Inventory (eBay Sync) | ORG | PRO | Human QA: verify import flow, Pull to Sale, direct push, post-sale panel | S455: eBay OAuth + import. S456: 86 items imported (photos, categories, conditions). S457: Pull to Sale fixed. S458–S459: GetItem enrichment + socket listener. S460: eBay push UI in 3 locations (sale detail, edit-item, review page), PostSaleEbayPanel (ENDED sales), shipping classification. S461: eBay push end-to-end working (6-round fix — Contigo mug ✅ Patrick-verified). S462: 17 new listing parity fields (UPC/EAN/ISBN/MPN/brand/EPID/subtitle/packageSize/bestOffer/secondaryCategory), HTML sanitizer, required aspects auto-fill, catalog product lookup. S463: Static category picker retired → live eBay Taxonomy API search-as-you-type. S464: ebayNeedsReview flag set on 25005 exhaustion, amber badge + "Set Category" button on sale detail. Billing webhook secret fixed (STRIPE_BILLING_WEBHOOK_SECRET). |
...
| 122 | ✅ | ✅ | ✅ | ✅ | ✅ | ⬜ | Chrome-verified S450 | Explorer's Guild Phase 1 | SHO | FREE | Chrome QA: XP scan cap (100/day), visit XP, Guild nav link, onboarding modal (localStorage-gated), Sage threshold 2500 (beta), Hunt Pass trial banner, SourcebookEntry + Sale.prelaunchAt schema | Shipped S342–S344 + S449–S450 |
| 133 | ✅ | ✅ | ✅ | 📋 | ✅ | ✅ | Chrome-verified S407 | Hunt Pass Subscription Redesign | SHO | PAID_ADDON | Human QA | S407 ✅: $4.99/month, 1.5x XP verified. S454 ✅: Stripe Subscription architecture rebuilt, Checkout flow wired, metadata routing complete. ||
| 213 | ✅ | ✅ | ✅ | NA | ✅ | ✅ | Chrome-verified S407 | Hunt Pass | SHO | PAID_ADDON | Human QA | S407 ✅: Core verified. S454 ✅: Recurring Stripe Subscription (Checkout mode), cancel-huntpass wired, billing webhook routing complete. ||
