...
**Last Updated:** 2026-04-08 (v103 — S418: Hunt Pass staleness audit + exchange-rate calibration to 1 XP = $0.01 anchor. Username Color 100, Frame Badge 200, Haul Visibility 25, Event Sponsorship 500, Seasonal Challenge 250, Hunt Pass discount 100, shopper coupon 100. Phantom "Public collection guide" earning row removed. ARCHITECT spec complete: unified BoostPurchase service with dual XP/Stripe payment rails (ADR-featured-boost-dual-rail-S418.md). 7 new sinks approved (Sale Bump, Treasure Trail Sponsor, Wishlist Notification, Profile Showcase, Guild Creation, Custom Map Pin; Lucky Roll deferred to gamedesign session). Three-tier shopper coupon system locked ($1/$10, $1.50/$20, $5/$50 with min purchase + monthly caps). Refund policy locked. NEW BROKEN entries below — S419 dispatches in parallel: Lucky Roll gacha design + BoostPurchase impl + Coupon generation + Hunt-pass cash column.)
...
| 288 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Locked S418 — Build Pending S419 | Featured Boost System (Dual-Rail XP/Stripe) | BOTH | ALL | Dispatch findasale-dev with ADR-featured-boost-dual-rail-S418.md. 12 ordered steps. Schema-first per CLAUDE.md §8. | Unified BoostPurchase service for 8 boost types (Sale Bump, Haul Visibility, Bounty Visibility, Event Sponsorship, Wishlist Notification, Seasonal Challenge Access, Guide Publication, Rarity Boost). New schema: BoostPurchase model + 3 enums + 4 indexes. New endpoints: /boosts/quote, /purchase, /active, /me. Stripe webhook branch. Cron expiry sweeper. New pricing constants file. Adding future boosts = enum + pricing row + UI button only. |
| 289 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Locked S418 — Build Pending S419 | Shopper Coupon Generation (3 Tiers) | SHO | FREE | Dispatch findasale-dev. Schema additions: minPurchaseAmount, generatedFromXp, xpTier on Coupon model. New endpoint POST /coupons/generate-from-xp. Server-side enforcement of monthly caps per tier. | 3 tiers: $1/$10 (100 XP, 1/mo), $1.50/$20 (150 XP, 3/mo, +$0.50 net), $5/$50 (500 XP, 1/mo). All require Stripe-cleared min purchase, no stacking with organizer coupons, 30-day expiry. Anti-fraud: real card transaction required for redemption. |
| 290 | NA | NA | ⬜ | NA | ⬜ | ⬜ | Spec Locked S418 — Build Pending S419 | Hunt Pass Page — Dual-Rail Cash Column | SHO | ALL | Dispatch findasale-dev (small task). Add cash-price column alongside XP cost in sinks table on hunt-pass.tsx once BoostPurchase ships. | Cosmetic update to hunt-pass.tsx to surface dual-rail pricing. Depends on #288 shipping first. |
| 291 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Design Pending S419 | Lucky Roll / Mystery Box (Gacha Mechanic) | SHO | FREE | Dispatch findasale-gamedesign. Output: pity counter, reward table, weekly cap, fairness model, regulatory check (loot box laws vary by jurisdiction). Then findasale-architect for implementation spec. | 100 XP per roll, weekly cap. Random reward: 50–500 XP, free coupon, rare cosmetic, or "nothing this time" with pity counter (guaranteed legendary on 10th roll). Standard gacha — controlled. Excluded from BoostPurchase ADR — needs own service. |
