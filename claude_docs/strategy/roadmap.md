...
**Last Updated:** 2026-04-03 (v93 — S388: pricing fix ($29/$79), XP thresholds to board numbers, AI branding purge (13 locations), camera coaching banner, 7 new FAQs, sale type inclusivity. Teams member count 5→12. #60 pricing now correct. #246–#249 new entries. Concurrent sales gate spec filed.)
...
| 249 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete — Needs Dev | SIMPLE Concurrent Sales Gate | ORG | SIMPLE | Architect spec at claude_docs/specs/concurrent-sales-gate-spec.md. Needs dev implementation. | Gate SIMPLE to 1 concurrent active sale, PRO to 3, TEAMS/ENT unlimited. maxConcurrentSales in tierLimits.ts + enforcement in sale creation route. 409 response + upgrade CTA. |
