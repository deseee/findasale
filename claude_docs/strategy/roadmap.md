...
| 228 | ✅ | ✅ | ✅ | ✅ | ⚠️ | ⬜ | ⚠️ Bug logged S525 | Settlement Hub (Commission Calc + Expense Tracker + Client Payout) | ORG | SIMPLE | Chrome QA ⚠️ S515: YARD sale → simple card correct. PUBLISHED warning shown. Add Expense ($50 Dumpster rental) saved, -$50 expenses updated, $80.39 earnings (ss_1092hccwc). P2: Add Expense form white in dark mode (fixed S515 — ExpenseLineItemList.tsx). P2: Initial $0 earnings with $130.39 revenue/$0 expenses — possible stale hydration. P3: No platform fee line visible. Estate wizard not tested (no ENDED estate sale available). | 4 new Prisma models (SaleSettlement, SaleExpense, ClientPayout, SaleTransaction). 7 backend endpoints. SettlementWizard.tsx + 3 sub-components. /organizer/settlement/[saleId] page. "Settle This Sale" button on edit-sale ENDED. |
...
| 241 | ✅ | NA | ✅ | ✅ | ❌ | ⬜ | ❌ S530 P1 — UI present, all 4 PDF endpoints (/api/brand-kit/organizer/[type]) return 404 | Organizer Brand Kit Expansion | ORG | PRO | Chrome QA: verify 4 PDF generators (business cards, letterhead, social headers, branded yard sign), PRO gate + SIMPLE upsell | S375: 4 PDF generators built. PRO-gated with SIMPLE upsell CTA. Integrated with existing #31 Brand Kit. |
...
| 266 | NA | NA | ✅ | ✅ | ❌ | ⬜ | ❌ Bug logged S525 | Collector Passport Nav Rename | SHO | FREE | Chrome QA: verify "Collector Passport" label in organizer sidebar, mobile nav (both locations), and AvatarDropdown | Layout.tsx: "Explorer Passport" → "Collector Passport" in 3 nav locations. AvatarDropdown.tsx: same rename in dropdown. Link still routes to /shopper/explorer-passport (page path unchanged). |
| 267 | NA | ✅ | NA | NA | ❌ | ⬜ | ❌ S530 P0 — XP award not firing; no Discoveries notification; XP delta unexplained after RSVP click | RSVP Bonus XP (2 XP, cap 10/month) | SHO | FREE | Chrome QA: RSVP to a sale, verify 2 XP awarded; RSVP 5+ times in a month, verify cap at 10 XP | rsvpController.ts: awards 2 XP on RSVP creation. xpService.ts: RSVP action + MONTHLY_XP_CAPS.RSVP=10, checkMonthlyXpCap(). |
