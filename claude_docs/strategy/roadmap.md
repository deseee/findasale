...
**Last Updated:** 2026-04-03 (v94 — S389: concurrent sales gate shipped (#249), Price Research Panel, Reverse Auction type, Flash Deal wired, TierComparisonTable SIMPLE limits corrected, Verified Purchase badge, SettlementWizard transfer ID/failure, priceBeforeMarkdown crossed-out prices, Scout hold bug fixed, Hunt Pass 1.5x multiplier wired, rank-up notifications, referral signup wiring. TS2451 saleController fix. Comprehensive alignment doc at S389-comprehensive-alignment.md. #250–#258 new entries.)
...
|   7 | ✅ | ✅ | ✅ | ✅ | ✅ | ⬜ | Shipped S389 — Needs UI page | Shopper Referral Rewards | SHO | FREE | S389: authController processReferral() called at signup (20 XP to referrer). stripeController awards 30 XP on referrer's first-purchase. Backend complete. Still needs: /shopper/referrals UI page showing referral code + status + history. | Referral tracking + rewards distribution |
