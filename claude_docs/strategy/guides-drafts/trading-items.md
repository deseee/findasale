...
linkFrom:
  - /shopper/trades
  - FAQ "Can I trade items on FindA.Sale?"
---
...
**Is there a fee to trade?**
No fee to propose or accept a trade. If cash changes hands alongside a swap, that goes through the normal pay request flow.

**What if the other person ghosts me?**
Proposals expire after 72 hours if the other party doesn't respond. You'll get a notification when a proposal expires.

**Can I cancel a trade I proposed?**
Yes. Go to your Trades inbox, open the proposal, and tap **Withdraw**. You can withdraw any proposal that hasn't been accepted yet.

**What if someone sends me a bad-faith trade proposal?**
Tap **Decline** and use the Report button on the proposal if needed. FindA.Sale reviews flagged trades.
