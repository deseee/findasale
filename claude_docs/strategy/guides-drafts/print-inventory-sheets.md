...
An inventory sheet is a printed list of your items with names, prices, conditions, and thumbnail photos. Hand one to a staff member and they can work the floor without needing their phone.
...
Full-sheet format fits fewer items per page; summary format fits significantly more since it omits thumbnails.
