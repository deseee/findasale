...
Shopify cross-listing syncs items from your sale to your Shopify store. If you already have a storefront, you don't need to re-enter anything. List it once in FindA.Sale, push it to Shopify, and it appears in your store.
