...
relatedGuides:
  ...
  - treasure-trails-shopper
linkFrom:
  - Sale detail post-purchase confirmation screen
  - /shopper/haul-posts
  - FAQ "What is a Haul Post?"
---

A haul post is a public photo and caption showing items you bought at a sale. It shows up on the organizer's sale page and your shopper profile, and helps other shoppers see what kinds of finds a sale typically offers. You earn XP every time you post one — check [/shopper/guild-primer](/shopper/guild-primer) for the current amount.
...
### Path 1: From your purchase confirmation
...
### Path 2: From your haul post history

Use this if you forgot to post right after a purchase, or if you want to go back and document an older find.

1. Go to [/shopper/haul-posts](/shopper/haul-posts).
2. Tap **New Haul**.
3. Select a sale from your purchase history. (Only sales you've attended or purchased from will appear.)
4. Upload a photo.
5. Write your caption.
6. Tap **Post**.

You can post up to one haul per sale visit. If you bought from multiple sales the same day, each gets its own haul post.

---

## What makes a good haul post?
...
**Weak example:** *"Great finds!!! So excited!!!"*

The first one helps another shopper know what to expect at that sale. The second one doesn't.

---

## Why haul posts matter to the community

When you post, you're doing three things at once:

1. **Building the organizer's reputation.** Organizers who consistently have good finds get documented proof of it over time. That helps them attract more shoppers without spending money on ads.

2. **Helping shoppers decide before they go.** Someone on the fence about driving 30 minutes will often check haul posts first. A good haul post can be what tips them.

3. **Earning XP toward your rank.** Each haul post contributes to your guild score. The more you post (up to the per-sale limit), the faster you climb. See [/shopper/guild-primer](/shopper/guild-primer) for exact XP values.
...
**What happens if I post an item that wasn't actually from that sale?**
...
*45-second screen-capture VO. Show the post-purchase confirmation screen, then the haul post creation flow, then a finished post as it appears on the sale page.*

---

[0:00–0:05]
*Screen: purchase confirmation page. "Post a Haul" button is visible.*

VO: "You just picked something up at a sale. Before you leave the confirmation screen, tap Post a Haul."
...
[0:15–0:28]
*Screen: caption field. User types: "Cast iron skillet, $8. Not a scratch on it." Post button visible.*

VO: "Write one or two lines: what it is, what you paid. That's the detail other shoppers actually want. Then tap Post."

---

[0:28–0:38]
*Screen: finished haul post shown on the sale's page, then on the shopper's profile.*

VO: "Your post shows up on the sale page, your profile, and the community feed. The organizer can share it. Other shoppers will see what this sale had."

---

[0:38–0:45]
*Screen: XP notification animation. Cut to /shopper/guild-primer page.*

VO: "You also earn XP for every haul post. Check your Guild Primer for the current amount."
