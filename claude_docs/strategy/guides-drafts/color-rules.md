...
linkFrom:
  - /organizer/color-rules empty state
  - FAQ "What are color tags for?"
---

Color rules turn a colored sticker into a price signal your whole team understands without looking anything up.
