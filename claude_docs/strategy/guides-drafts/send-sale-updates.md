...
relatedGuides:
  ...
  - brand-kit
linkFrom:
  - /organizer/send-update
  - Dashboard follower count widget
---
...
## What makes a good update vs. a bad one
...
| Bad update | Why it does not work |
|------------|---------------------|
| "Still lots of stuff!" | No specifics. Gives no reason to come. |
| "We had a great first day, thanks everyone!" | Recap, not a call to action. No reason to read. |
| "Check the website for updates." | Sends people away without telling them why. |
