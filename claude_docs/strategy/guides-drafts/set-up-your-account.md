...
linkFrom:
  - /register
  - organizer dashboard empty state
---
...
"Welcome to FindA.Sale. Here's exactly what to do to get your account set up.
...
Then connect Stripe. Go to Settings, then Payouts, and click Connect with Stripe. Stripe is how we send you your money. We've got a full guide on that if you need it.
