...
Consignment means someone else's items are listed and sold through your sale. You manage the photos, pricing, and transactions. After the sale closes, you pay them their share. FindA.Sale tracks every consignor's items separately so the math happens automatically.
