...
relatedGuides:
  ...
  - discount-rules-and-markdowns
linkFrom:
  - /organizer/holds
  - hold request notification
  - FAQ "How do I approve a hold?"
---

A hold lets a shopper reserve an item before they arrive to pick it up. You stay in control — you approve or deny, set the window, and release the item if they don't show.
