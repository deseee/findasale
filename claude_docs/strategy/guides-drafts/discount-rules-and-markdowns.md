...
relatedGuides:
  ...
  - manage-holds
linkFrom:
  - /organizer/discount-rules
  - /organizer/markdown-cycles
  - FAQ "Can I discount items automatically?"
---

You have two tools for automatic price changes: discount rules and markdown cycles. They solve different problems. This guide covers both.
