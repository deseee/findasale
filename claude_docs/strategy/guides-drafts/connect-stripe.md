...
linkFrom:
  ...
  - payout section of /guide
---

Stripe is how FindA.Sale sends you your earnings. You set it up once in Settings and then it handles every payout automatically.
...
You can run a sale without Stripe. Shoppers can place holds and pay cash at pickup. You won't be able to accept card payments online or at the point of sale, and you won't be able to use the POS card-tap feature on sale day. Most organizers connect Stripe before their first sale goes live.
