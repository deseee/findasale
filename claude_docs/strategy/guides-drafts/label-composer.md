...
relatedGuides:
  ...
  - color-rules
linkFrom:
  - /organizer/label-composer
  - print-inventory-sheets guide
---

The label composer generates printable price tags with item names, prices, and QR codes. Print them at home, stick them on items before your sale opens, and let shoppers scan for details on anything that catches their eye.
