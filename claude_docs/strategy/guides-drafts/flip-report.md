...
relatedGuides:
  ...
  - settle-up-reconcile-sales-and-get-your-payout
linkFrom:
  - /organizer/flip-report
  - /organizer/dashboard (analytics link)
---

The flip report shows you whether your prices are working. It compares what you asked to what you got, and how long each item sat before it sold. Over time it tells you where you're consistently leaving money on the table — and where you're underpricing items that fly off the floor.
