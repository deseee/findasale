...
treatment: FRESH
section: 4.3
links-from: /organizer/photo-ops
---
...
1. **Position the item** on the table.
2. **Adjust light** if needed (move the lamp, rotate the item, angle the phone).
3. **Frame it** in the camera viewfinder (item fills 50–70% of the frame).
4. **Shoot** once or twice. You're in Rapidfire mode, so don't stop to check—just capture.
5. **Move it off** and bring the next item.
