...
| Weekly-audit fixes (H-002 map pins; M-005 sale-type badge; M-006 directions link; M-008 category dedupe; L-002/L-003/L-004/L-005/L-006 polish) | Fixed + pushed after 2026-05-30 weekly audit; not yet Chrome-verified post-deploy | Chrome QA: (1) /map shows visible pins; (2) "Fantastic Estate Auction" no longer shows YARD badge; (3) coordless sale shows "Get directions"; (4) /categories has one "Tins" card + real icons. Full list: audits/weekly-audit-2026-05-30.md | S-audit-0530 |
