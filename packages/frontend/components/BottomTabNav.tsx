...
const BottomTabNav = () => {
  ...
  return (
    <>
      ...
      {exploreSheetOpen && (
        <>
          <div className="fixed inset-0 bg-black/40 z-50 md:hidden" role="button" tabIndex={0} aria-hidden="true" onClick={() => setExploreSheetOpen(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setExploreSheetOpen(false); } }} />
