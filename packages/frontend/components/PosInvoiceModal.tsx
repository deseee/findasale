...
export default function PosInvoiceModal({ hold, miscItems = [], sessionId, cashAmountCents = 0, onClose, onSent }: PosInvoiceModalProps) {
  ...
  return (
    <AccessibleModal
      isOpen={true}
      onClose={onClose}
      ariaLabelledBy="pos-invoice-modal-title"
      contentClassName="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md max-h-[90vh] overflow-y-auto"
    >
      {/* Header */}
      <div className="flex justify-between items-center pb-4 border-b border-gray-200 dark:border-gray-700 mb-6">
        <h2 id="pos-invoice-modal-title" className="text-lg font-semibold text-gray-900 dark:text-white">
