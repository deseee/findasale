...
const RANK_COLORS: Record<string, string> = {
  ...
  SCOUT: 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300',
  RANGER: 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300',
  SAGE: 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300',
  GRANDMASTER: 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300',
};
