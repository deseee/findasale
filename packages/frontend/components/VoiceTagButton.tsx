    ...
    return (
      ...
      >
        ...
        >
          ...
          <path d="M17 16.91c-1.48 1.46-3.51 2.36-5.76 2.36s-4.29-.9-5.77-2.36l-1.44 1.44c1.96 1.97 4.68 3.19 7.2 3.19s5.25-1.22 7.2-3.19l-1.43-1.44zM19.07 4.93L17.65 6.35c.75 1.35 1.19 2.88 1.19 4.5s-.44 3.15-1.19 4.5l1.43 1.43c1.13-1.49 1.81-3.38 1.81-5.43s-.68-3.94-1.81-5.43z" />
        </svg>
      </button>
    );
  }
