...
const EntrancePinPickerInner: React.FC<EntrancePinPickerInnerProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Entrance Note Input */}
      <div>
        <label className="block text-sm font-semibold mb-1">Entrance Note (Optional)</label>
        <input
          type="text"
          value={entranceNote}
        ...
        />
        <p className="text-xs text-gray-500 mt-1">{entranceNote.length}/150 characters</p>
      </div>
