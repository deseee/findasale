        ...
        <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            ...
            <input
              ...
              aria-label="Amount" onChange={(e) => setNewExpense({ ...newExpense, amount: e.target.value })}
              className="text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              required
            />
          </div>
          <input
            ...
            aria-label="Description (e.g., Dumpster rental)" onChange={(e) => setNewExpense({ ...newExpense, description: e.target.value })}
          ...
          <input
            ...
            aria-label="Vendor name (optional)" onChange={(e) => setNewExpense({ ...newExpense, vendorName: e.target.value })}
            className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
          />
