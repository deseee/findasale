...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 3,
  relatedGuides: ['affiliate-links', 'build-organizer-reputation', 'schedule-a-sale-and-pick-your-visibility-window'],
  videoUrl: undefined,
  body: `When shoppers share your sale, post haul photos, or promote your listing through the FindA.Sale share flow, that activity shows up in one place: the Ripples page. It is a live feed of public attention around your sale.

---

## What Ripples is

Ripples collects public activity tied to your sale:

- Shoppers who used the FindA.Sale share button to post your sale to social platforms
...
**Identify which platform is moving your sales.** If you see a concentration of shares from Nextdoor that coincides with a spike in holds, that tells you where your audience lives. Lean into that platform for your next promotion.
...
## What Ripples does not track

- Private messages (SMS, DMs on any platform, email)
- Shares made by copying your URL directly without using the FindA.Sale share button
- Organic social posts that mention your sale without going through the platform
- Print or offline mentions

This means Ripples shows you a subset of your real-world reach. The actual number of people talking about your sale is almost certainly higher. Ripples is the visible part of the iceberg.

---

## Common questions

**Can shoppers see the Ripples page?**
...
**What if I see something in Ripples that looks inaccurate or that I want removed?**
...
- [Affiliate links: track sales you promote](/guides/affiliate-links)
