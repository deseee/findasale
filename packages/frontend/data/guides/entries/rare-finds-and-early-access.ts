...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 2,
  relatedGuides: ['hunt-pass', 'how-ranks-work', 'achievements'],
  videoUrl: undefined,
  body: `# Rare Finds and Early Access: why subscribers see items first
...
## How to find Rare and Legendary items

Two ways:

1. **Filter in search.** Open the search bar, tap Filters, and select Rarity. You'll see all currently available Rare and Legendary items across active sales.
2. **Watch your feed.** If you follow organizers who regularly list high-value inventory, their Rare and Legendary items will surface in your feed with the badge visible.
