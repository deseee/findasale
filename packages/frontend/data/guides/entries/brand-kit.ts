...
const entry: GuideEntry = {
  slug: 'brand-kit',
  title: "Set up your brand kit (logo, colors, and storefront URL)",
  audience: 'organizer',
  format: 'written',
  priority: 2,
  relatedGuides: ['share-cards', 'promote-page', 'yard-signs-and-qr-codes'],
  videoUrl: undefined,
  body: `Your brand kit sets the logo, accent color, and custom storefront URL that appear on your share cards, print materials, and public organizer profile. You set it once and it flows automatically into everything FindA.Sale generates for you. This guide walks through each field and what it affects.
...
Go to /organizer/brand-kit. You will see three sections: Logo, Accent Color, and Storefront URL.

### Logo

1. Tap **Upload logo**
2. Select your file from your phone or computer
3. Crop or reposition if needed, then tap **Save**
...
1. Tap the color swatch next to **Accent color**
...
Keep it short. You will be saying this URL out loud to customers and typing it on signs.

**Note:** You can change your storefront URL later, but any links you have already shared with the old URL will stop working. Pick something you plan to keep.

---

## How the brand kit flows into your materials

Once your brand kit is saved, every template in FindA.Sale picks it up automatically:

| Material | What updates |
|----------|-------------|
| Share cards | Logo in corner, accent color as background or highlight |
| Print card (from promote page) | Logo, accent color, storefront URL |
| Flyer template (from print kit) | Logo in header |
| Organizer profile page | Logo as profile image, storefront URL in address bar |
| Email share template | Logo in header |

You do not need to re-upload anything. Save the brand kit once and it carries through.

---

## Common questions

**Do I need a logo to use FindA.Sale?**

No. The logo field is optional. If you skip it, your share cards and print materials use a placeholder icon. Adding a logo just makes things look more consistent.

**What if my logo has a white background?**

It will still work. On light-colored share cards it looks fine. On dark or colored backgrounds there will be a white box around it. For the cleanest look, use a PNG with a transparent background. If you only have a JPG, use a free tool like remove.bg to strip the background before uploading.

**Can I have a different brand for different sale types?**

Not currently. One brand kit applies to all sales under your organizer account. If you run significantly different types of events under different business names, consider creating separate organizer accounts.
