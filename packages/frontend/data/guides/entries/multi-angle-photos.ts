...
## Standard 4-angle approach

For most high-value items, four photos cover everything a buyer needs:

**1. Front**
The main listing photo. Item facing forward, well-lit, item filling 70–80% of the frame. This is what buyers see in search results.

**2. Back**
Flip the item and shoot the reverse. For furniture: back panel, leg condition, any markings. For clothing: tag with brand and size. For electronics: port layout, model label. For art: label, hanging hardware, backing condition.

**3. Detail**
The part that matters most for condition. For furniture: a scratch, a hinge, the hardware. For jewelry: the stone setting, the clasp. For ceramics: any chips or repairs. For electronics: the screen surface, button wear.

**4. Label or serial number**
If the item has a manufacturer's label, model number, serial number, or hallmark, photograph it legibly. This is especially important for collectibles, vintage items, and electronics where buyers may want to verify authenticity or look up parts.
...
## How to add photos after a rapidfire session

Rapidfire mode captures one photo per item and moves you forward. To add more angles:

1. Go to your sale dashboard.
2. Find the item: either in the review queue or in your active item list.
3. Tap the item to open the edit view.
4. Tap **Add Photo** (or the camera icon / plus icon in the photo section).
5. Take the photo or choose from your camera roll.
6. Repeat for each additional angle.
7. Tap **Save**.
...
## Tips for shooting detail and label shots
...
There's no penalty for having more photos, but buyers mostly look at the first two or three. After four, returns are diminishing unless the item is very high value or has significant detail variation. Focus on quality over quantity.

**Should the first photo always be the front?**
Yes. The first photo is what shows up in search results and at the top of the item listing. It should be the clearest, most representative view of the item. Save detail and back photos for positions 2–4.

**What if I didn't photograph an item's label during the session and I've already packed up?**
If the label is important for value (vintage marks, sterling hallmarks, electronics model numbers), it's worth finding the item and getting that shot. If it's not critical, use the description field to note what you know about it.

**Can buyers ask me for more photos?**
Yes, buyers can send messages through the listing. If someone asks for a specific angle, you can add the photo to the item and reply that you've updated it. That conversation often closes the sale.

**Does adding more photos affect the suggested price?**
The suggested price is based primarily on the item description and the first photo. Additional angles don't recalculate the price, but they make buyers more confident in what they're buying, which supports your asking price.
