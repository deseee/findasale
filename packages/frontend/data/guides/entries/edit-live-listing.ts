...
const entry: GuideEntry = {
  ...
  videoUrl: undefined,
  body: `Publishing an item doesn't lock it. You can edit any live listing at any time before the sale ends — price, description, condition, photos, category, tags — all of it. Changes take effect immediately. No re-publishing required.
...
Yes. Photograph new items, review them in the queue, and publish. They go live on the existing sale page without any disruption to what's already there.

**What if I change the price right before a sale opens?**
Price changes are instant. There's no delay. Whatever price is set when a shopper views the item is the current price.
