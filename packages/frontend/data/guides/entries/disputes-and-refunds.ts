...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 3,
  relatedGuides: ['organizer-reputation', 'build-organizer-reputation', 'manage-holds-approve-extend-cancel'],
  videoUrl: undefined,
  body: `Most issues between shoppers and organizers resolve with a direct message. If that does not work, FindA.Sale has a dispute process. Here is how it works for both sides.
...
1. Open the sale detail page for the transaction in question.
2. Tap **Report Issue**.
3. Describe what happened. Include specifics: what the listing said, what you found at pickup, what you expected versus what occurred.
4. Submit.
...
## For organizers: how disputes affect you
...
Yes. Disputes must be filed within 7 days of the sale close date or within 7 days of the scheduled pickup, whichever is later.

**Can I dispute a sale that happened outside FindA.Sale?**
No. FindA.Sale's dispute process only covers transactions that went through the platform. Cash deals made outside the app are between the buyer and seller directly.
