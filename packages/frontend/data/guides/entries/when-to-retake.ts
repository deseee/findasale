...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 1,
  relatedGuides: ['rapidfire-mode', 'lighting-and-framing', 'multi-angle-photos'],
  videoUrl: undefined,
  body: `After a rapidfire session, some items in your review queue will have an orange **Retake** nudge. This guide explains what triggers it, what each photo problem actually means for buyers, and when it's worth your time to reshoot versus just publishing and moving on.
...
## Fixing photos in review vs. retaking at the source
...
There's no limit, but retaking everything the nudge flags will slow you down significantly. Retake the items where the photo quality will actually affect whether someone buys or what they'll pay. Skip everything else.
