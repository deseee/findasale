...
1. Go to [/shopper/bounties](/shopper/bounties).
2. Tap **New Bounty**.
3. Fill in the item description. Be specific: maker, model, pattern, era, condition requirements. Add dimensions if size matters.
4. Set your **price ceiling**: the maximum you'd pay for a match in good condition. Organizers see this number. It signals seriousness and sets expectations.
5. Set an **expiry date**. Most bounties run 30–90 days. After that date, the bounty closes automatically.
6. Tap **Post Bounty**.
...
1. Tap the bounty with a pending claim.
2. Review the organizer's listing: photos, condition description, asking price (at or below your ceiling), and the sale it's coming from.
3. If the item matches what you asked for, tap **Accept Claim**. The item goes into a hold attached to that sale.
4. If it doesn't match, tap **Decline**. The bounty stays open for other organizers to claim.
...
**Can I post more than one bounty at a time?**
Yes. There's no limit on active bounties. Each one is independent.

**Will I get a notification for every claim, or just the first?**
You get a notification for every claim. You review and accept or decline each one. Only one claim can be accepted per bounty.

**Can I negotiate price with an organizer who claims my bounty?**
Not through the bounty system. The organizer sets the price; you accept or decline. If you want to discuss it, you can message the organizer directly through their sale page, but bounty claims aren't a negotiation tool.

**What if an organizer claims my bounty but the item has damage I didn't agree to?**
Decline the claim. The description and photos are provided by the organizer and you review them before accepting. If you accept and then the item doesn't match what was shown, that's a dispute between you and the organizer. Contact support through the sale page.

**Do bounties earn XP?**
Posting a bounty does not earn XP directly. Completing a purchase from an accepted bounty claim earns the normal purchase XP. Check [/shopper/guild-primer](/shopper/guild-primer) for current amounts.

**Is there a way to see which organizers claimed my bounties in the past?**
Yes. From [/shopper/bounties](/shopper/bounties), tap **Closed** to see your expired and closed bounties. Each claim that came in (accepted or declined) is listed in the bounty history.
