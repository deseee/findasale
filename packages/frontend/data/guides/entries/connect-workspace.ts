...
const entry: GuideEntry = {
  slug: 'connect-workspace',
  title: "Connect your workspace (multi-organizer setup)",
  audience: 'organizer',
  format: 'written',
  priority: 3,
...
## How workspaces differ from staff accounts

The distinction matters:

| | Staff accounts | Workspace members |
|---|---|---|
...
## What workspace members keep separate
...
**Can a workspace member be on a different plan?**
Workspace members don't need their own paid plan — the workspace owner's Teams subscription covers them while they're part of the workspace. If they leave the workspace, they revert to whatever plan they had before joining.

**What if two workspace members want to work the same sale together?**
They can't co-own a single sale — each sale belongs to one organizer. For collaborative sales, one organizer creates the sale and uses staff accounts to bring in the other organizer as a Manager. The two tools work together.
...
**How many organizers can be in one workspace?**
There's no hard cap. The Teams plan is priced per workspace, not per seat.
