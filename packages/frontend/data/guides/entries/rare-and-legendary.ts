...
## How the tag gets applied (and how you confirm it)
...
To confirm: leave the badge as-is when you approve the item.
To dismiss: tap the badge and select **Remove tag**. The item publishes without the rarity designation.
...
**Does adding a Rare tag change the price?**
No. Rarity tags affect discoverability and placement, not price. Set the price as you normally would based on comparable sales and your own assessment.

**What if the app tags something Rare that clearly isn't?**
Dismiss the tag. Tap the badge and select Remove tag. Inaccurate rarity tags create disappointed shoppers when the item doesn't live up to the designation.

**Can I tag every item in my sale as Rare?**
The app won't prevent it, but it undermines the tag's value. Shoppers who filter by Rare are looking for genuinely unusual items. A sale where everything is tagged Rare will see those shoppers skip the filter and lose the benefit entirely.
