...
**Q: Are sales sorted by anything other than distance?**
Within each distance band, sales are sorted by how recently the organizer posted. Newest posts first, within the same distance range.

**Q: Can I filter a city page by sale type?**
Not with a dropdown filter, but the sale type label is on every listing. Scroll until you see the type you want, or use the type counts at the top to know if it's worth looking.

**Q: Can I get notified when a new sale posts in a specific city?**
