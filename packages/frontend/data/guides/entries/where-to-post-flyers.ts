...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 1,
  relatedGuides: ['promote-page', 'yard-signs-and-qr-codes', 'share-cards'],
  videoUrl: undefined,
  body: `Flyers still work. A sheet of paper on a laundromat bulletin board pulls in shoppers who never open social media. This guide covers the 8–10 best spots to post physical flyers, how far in advance to post, how the tear-off flyer format works, and how to get them printed without spending much.
