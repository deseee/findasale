...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 3,
  relatedGuides: ['pay-requests', 'trading-items', 'holds-for-shoppers'],
  videoUrl: undefined,
  body: `The loot log is a running record of every item you've purchased through FindA.Sale. Every confirmed buy (estate sale furniture, yard sale tools, auction wins, flea market finds, consignment pickups) lands here automatically. You don't have to enter anything.
...
**Does the loot log include cash purchases I made in person?**
Only if the organizer confirmed the sale through FindA.Sale. If you paid cash and the organizer marked the item as sold to you in the app, it appears. If the transaction happened entirely off-platform, it won't.

**Can I add items I bought before joining FindA.Sale?**
Not currently. The log captures purchases made through the platform. Manual import isn't available yet.

**Is my loot log visible to other shoppers?**
The full log is private. Your Loot Legend summary (totals only, no item details) is visible on your public profile if you've turned on a public profile. Item details are never public.

**How do I delete an entry?**
You can't delete entries: the log is a record, not a list you curate. You can mark items as traded or sold, and you can add notes. If an entry was added in error, contact the organizer who confirmed the sale.

**Does the log track trades?**
Items you received through accepted trades appear in the log if the organizer confirmed the exchange through the app. Items you traded away are marked "Traded" in your history.

**Is there a limit to how many entries the log holds?**
No limit.
