...
**Do staff accounts cost extra?**
Staff accounts are included in the Teams plan. There's no per-seat fee.

**Can a staff member be on multiple organizations?**
...
**Does a staff member see the prices I paid for items?**
No. Staff see the selling prices you set. Cost-basis fields (if you've entered them) are visible only to the account owner and Managers.
