...
const entry: GuideEntry = {
  ...
  priority: 1,
  relatedGuides: ['browse-by-city', 'sale-planner', 'wishlist-and-notifications'],
  videoUrl: undefined,
...
Tap "Calendar" at the top of the search screen. You'll see a week grid. Days with sales show a colored dot.

Tap a day to see all sales starting on that date. Useful for planning a Saturday route before the weekend gets here.
...
**Upcoming** means the sale has been posted but hasn't started yet. You can browse its item listings, save it to your wishlist, and set a reminder. You can't buy or hold anything until it goes active.

---

## Common questions

**Q: How far away does "near me" search?**
The default is 25 miles. Change it any time by tapping Filter and adjusting the distance slider.

**Q: I'm traveling. Can I search a different location?**
Tap the location icon at the top and type a city or zip code. The map recenters on that spot.

**Q: Why does the map show a sale that isn't open yet?**
Organizers post in advance. If it says Upcoming, it hasn't started. Tap into it to see the start date.

**Q: Can I filter by price range on the map?**
Not on the map itself. Open a sale's detail page and use the item filter there to search by price.
