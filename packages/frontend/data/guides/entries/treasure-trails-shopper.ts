...
1. Tap **Follow this Trail** on the Trail detail page. This adds it to your active Trails list.
2. On sale day, open the Trail from [/shopper/trails](/shopper/trails) or from the notification reminder (if you have notifications on).
3. The Trail opens to a map with numbered stops in suggested order.
4. Tap each stop to see the sale detail, check hours, and browse items.
5. When you arrive at a stop, tap **Check In** on the sale page. The app marks that stop complete on your route.
...
## How to share a Trail with friends
...
**The sale planner at [/plan](/plan)** is self-serve. You set your starting address, the sale types you want, a radius, and a time window. The planner builds a route from your inputs. Use the planner when you have specific sale types you want, or when there's no active Trail covering your area on the day you want to go.
...
**Can I create my own Trail?**
Not as a shopper. Trail creation is currently available to organizers and to FindA.Sale's editorial team. If you have a route idea (a regular grouping of sales in your area), the best path is to mention it in a review or through the feedback form. It can be considered for a platform-published Trail.

**Do I have to follow a Trail on the date it's scheduled?**
Trails are tied to the actual sale dates, so yes. The sales themselves only run on their scheduled dates. You can browse a Trail before the date to plan, but check-ins and completion only apply when the sales are actually open.

**What if one stop on the Trail is canceled?**
If a sale cancels, that stop is marked as unavailable on the Trail map. FindA.Sale will adjust completion requirements if a stop cancels: you won't be blocked from the completion badge because of a cancellation outside your control.

**Is the Trails feature available everywhere?**
Trails are available wherever FindA.Sale has active sales. In areas with fewer sales, there may be fewer Trails or none at all on a given weekend. The platform-published Trails expand as more sales are listed in a region.

**Can I follow multiple Trails at once?**
Yes. You can follow as many active Trails as you want. They'll all appear in your Trails list at [/shopper/trails](/shopper/trails).

**Does completing a Trail affect my leaderboard standing?**
The XP from Trail completion counts toward your monthly and all-time totals, which feed the leaderboard. The Trail badge itself is cosmetic: it shows on your profile but doesn't add a separate multiplier.
...
[0:00–0:06]
*Screen: homepage map with Trails filter active. A route line appears over the map with numbered pins.*
...
[0:06–0:15]
*Screen: Trail detail page. Stop list visible with sale names, times, and a thumbnail of items.*
...
[0:15–0:22]
*Screen: map in navigation mode. Stop 2 is tapped. "Check In" button visible on the sale page.*
...
[0:22–0:30]
*Screen: completion screen with badge animation. XP total updates.*
