...
const entry: GuideEntry = {
  ...
  title: "Lighting and framing for better photo results",
  audience: 'organizer',
  format: 'written+video',
  priority: 1,
  relatedGuides: ['rapidfire-mode', 'when-to-retake', 'photo-stations'],
  videoUrl: undefined,
  body: `Good photos sell items faster and at better prices. You don't need a camera or lighting equipment — just your phone and a few habits that take about ten seconds per item to apply. This guide covers what actually makes a difference, and what you can skip.
...
## Quick checklist before you tap the shutter
...
**What if the room just has bad light and I can't change it?**
Move the item if you can — even to a doorway. If you can't, shoot with flash for matte items, no flash for shiny ones. A slightly underexposed photo with good detail is better than a perfectly lit photo where you can't see the surface.

**How much does background really matter?**
It matters more for price accuracy than it might seem. The photo recognition does better when the item is isolated on a plain surface. For common items (books, dishes, tools) it doesn't matter much. For specialty or collectible items, a clean background makes a real difference in how well the suggested title and price match.

**Do I need to set up a backdrop for a yard sale?**
No. For most yard sale items — priced $1–$20 — the photo just needs to be clear enough that buyers know what they're getting. A clean photo taken on a table in natural light is enough. A formal backdrop matters more for higher-priced items.

**My photos keep coming out blurry. What's wrong?**
Either the phone is moving when you tap the shutter, or the camera is focusing on the background instead of the item. Tap the screen directly on the item before shooting — this locks focus. Hold the phone steady and tap gently rather than jabbing the shutter.

**Should I use portrait mode (the phone's built-in blurring effect)?**
No. Portrait mode blurs the background artificially and sometimes blurs the edges of the item too, especially if the item has thin parts like handles or legs. Use the standard camera mode.
