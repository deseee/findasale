...
const entry: GuideEntry = {
  slug: 'build-organizer-reputation',
  title: "Build your reputation as an organizer",
  audience: 'organizer',
  format: 'written',
  priority: 2,
  relatedGuides: ['organizer-reputation', 'disputes-and-refunds', 'schedule-a-sale-and-pick-your-visibility-window'],
  videoUrl: undefined,
  body: `Your reputation on FindA.Sale is the first thing a shopper checks before deciding to make the trip. A strong rating gets you better placement in search, makes shoppers more likely to place a hold, and gives new visitors a reason to trust you before they have ever been to one of your sales.
...
Yes, in your [reviews dashboard](/organizer/reviews). You can see the shopper's name and purchase history. You cannot contact them through FindA.Sale to dispute the review.

**Do reviews from older sales count toward my current rating?**
Yes, all reviews are included in your rolling average. There is no expiration, but the display sorts by recency so older reviews are less prominent.

**Will bad reviews disappear over time?**
They do not disappear, but they become a smaller portion of your average as you accumulate more reviews. Running more sales and getting more positive reviews is the only way to move the number.
