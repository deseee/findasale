...
const entry: GuideEntry = {
  ...
  format: 'written',
  priority: 3,
  relatedGuides: ['earn-xp-for-free', 'how-ranks-work', 'achievements'],
  videoUrl: undefined,
  body: `# Streak rewards: daily logins and how to keep them going

A streak is the number of consecutive days you've logged in. The counter goes up by one each day you sign in. It resets to 1 if you miss a day. That's it.

The rewards grow as your streak gets longer.
...
**[View current streak rewards →](/shopper/guild-primer)**

---

## What counts as a login

Opening the app or visiting the site while signed in. You don't have to purchase anything, place a hold, or interact with a listing. Just showing up counts.

If you're on your phone, opening the app and letting it load to your dashboard is enough.
...
Some shoppers set a daily phone reminder. Thirty seconds keeps a long streak alive.

---

## What happens when a streak breaks

The counter resets to 1. You start a new streak from that day.
...
**What if the app was down and I couldn't log in?**
