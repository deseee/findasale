...
const entry: GuideEntry = {
  slug: 'organizer-reputation',
  title: "How organizer reputation works (and why you can trust ratings)",
  audience: 'both',
  format: 'written',
  priority: 1,
  relatedGuides: ['build-organizer-reputation', 'disputes-and-refunds', 'find-sales-near-you'],
  videoUrl: undefined,
  body: `Organizer ratings on FindA.Sale come from real shoppers who held or purchased items at that sale. Here is what those numbers mean and how to read a profile before you drive out.
...
**Can an organizer pay to boost their rating?**
No. Ratings come only from verified post-sale reviews. There is no paid placement for star scores.

**What if I see a fake-looking review?**
Use the flag option on the review. FindA.Sale reviews flagged content and removes it if it violates platform rules.

**Do organizers know who left a review?**
Reviews are linked to a shopper account but display only the shopper's first name and last initial. Organizers can see who reviewed them in their dashboard, but they cannot contact reviewers through the platform to dispute a rating.

**Is a new organizer with no reviews safe to buy from?**
There is no guarantee either way. Check whether they have a verified profile, read their sale description carefully, and message them with any questions before you commit to a hold.
