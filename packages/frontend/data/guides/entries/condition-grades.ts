...
const entry: GuideEntry = {
  ...
  videoUrl: undefined,
  body: `The condition grade is one of two signals shoppers use to decide whether to hold or buy an item before seeing it in person — the other is the photo. Getting it right reduces disputes, reduces holds that fall through, and builds the kind of trust that brings shoppers back to your next sale.

The app suggests a grade based on the photo. You confirm or change it before approving the item.

---

## What the grades mean (organizer's view)
...
## Why accurate grades reduce disputes and holds
...
## Full condition guide with photo examples
...
**What grade should I use if something works but looks rough?**
C or D, depending on severity. If it works fully but has clear cosmetic damage, use C. If function is questionable or it's untested, use D. See /condition-guide for side-by-side examples.

**The app suggested A but I think it's B — should I change it?**
Yes. Photo recognition works from the image you captured. If the item has wear that wasn't captured clearly (underside, interior, back of frame), update the grade manually. Your assessment of the physical item is more reliable than the photo.

**Can I change the condition after an item is live?**
Yes. Open the item from your live sale, edit the condition, and save. The change takes effect immediately. If a shopper has an active hold, they'll see the updated grade.
