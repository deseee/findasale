...
A faster, better-priced catalog is a real improvement to how a sale gets prepared. It has nothing to do with how a sale gets discovered. Those are two separate problems, and it's easy to assume that solving the first one solves the second, as if a listing looking professional enough is what makes buyers find it.
...
The organizers getting the most out of this moment aren't the ones with the single best cataloging tool. They're the ones treating cataloging and discovery as the two separate jobs they actually are, and they don't assume that solving one automatically takes care of the other.
