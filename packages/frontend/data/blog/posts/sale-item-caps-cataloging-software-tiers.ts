...
export const postAA: BlogPost = {
  slug: 'sale-item-caps-cataloging-software-tiers',
  title: 'What Happens When Your Sale Has More Items Than Your Software Plan Allows',
  metaDescription: 'Some cataloging tools cap monthly listings — a problem when one estate sale has more items than the plan allows. Here is how to avoid a mid-sale upgrade.',
  publishDate: '2026-10-15',
  category: 'guides',
  readingTimeMinutes: 6,
  excerpt: "A lot of cataloging software prices itself by how many items you list per month. That's an odd way to price a tool meant for estate sales, where a single house can blow past the entry tier on its own.",
  body: `## The pricing question nobody asks until it's too late
