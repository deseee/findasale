...
export const postF: BlogPost = {
  slug: 'estate-sale-listing-page-convert-ad-traffic',
  title: 'You\'re Spending on Ads. Is Your Listing Earning It Back?',
  metaDescription: 'Estate sale organizers spent over $18 million on Facebook ads in Q1 2026. A lot of that traffic bounces off listings that don\'t actually work for shoppers. Here\'s what converts.',
  publishDate: '2026-07-02',
  category: 'guides',
  readingTimeMinutes: 5,
  excerpt: 'Estate sale organizers spent over $18 million on Facebook ads in Q1 2026. The fix isn\'t better ads. It\'s a listing that actually does the work when buyers arrive.',
  body: `Estate sale organizers collectively spent over $18 million on Facebook ads in the first quarter of 2026. That's not a rounding error. That's a real, industry-wide commitment to digital marketing.
