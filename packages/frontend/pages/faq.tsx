...
const shopperFAQs: FAQItem[] = [
  // Discovery - First-time user questions
  {
  ...
  // At the sale - Holds and special features
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        the winning bid. It is <strong>5%</strong>, set by FindA.Sale and the same on every auction. It is
        shown on the sale page and on the bid form before you bid, itemized at checkout, and you confirm
        it before paying. A $200 winning bid comes to <strong>$210.00</strong>: $200 to the
        organizer&apos;s sale total, $10 buyer&apos;s premium. Some organizers choose to absorb the
        premium themselves, in which case you pay exactly your bid and the checkout says so.
        <br /><br />
  ...
  // After purchase - Issues and communication
  {
  ...
  // Loyalty and rewards - Engagement features
  {
