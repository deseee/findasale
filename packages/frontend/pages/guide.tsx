...
const sections: Section[] = [
  {
    ...
    content: (
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-warm-800">Creating Your Account</h3>
        ...
        <h3 className="text-xl font-semibold text-warm-800 mt-6">Connecting Stripe (Required for Payouts)</h3>
        <p className="text-warm-700 leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-warm-800">Uploading Photos</h3>
        <p className="text-warm-700 leading-relaxed">
        ...
        <h3 className="text-xl font-semibold text-warm-800 mt-6">AI Auto-Tagging</h3>
        <p className="text-warm-700 leading-relaxed">
        ...
        <h3 className="text-xl font-semibold text-warm-800 mt-6">Setting Price</h3>
        <p className="text-warm-700 leading-relaxed">
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-6xl mx-auto px-4 py-10">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-warm-900 mb-2">Organizer Guide</h1>
            <p className="text-warm-500 text-lg">Everything you need to run a successful estate sale on FindA.Sale.</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0">
              {sections.map((s) => (
                ...
                >
                  <div className="mb-4 pb-4 border-b border-warm-100">
                    <h2 className="text-2xl font-bold text-warm-900">{s.title}</h2>
                  </div>
              ...
              {/* Help link */}
              <div className="mt-8 p-4 bg-amber-50 rounded-lg text-sm text-warm-700">
