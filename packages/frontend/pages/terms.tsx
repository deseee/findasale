    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold text-warm-900 dark:text-warm-100 mb-2">Terms of Service</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">1. Eligibility</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">3. Accounts</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-3">
              ...
              checkout in addition to the bid amount. The rate is <strong>5%</strong>. It is set by FindA.Sale, is
              the same on every auction, and is not configurable by the Organizer. It is disclosed on the sale page
              and on the bid form before a bid is placed, itemized at checkout, and acknowledged by the buyer before
              payment; the rate charged is always the rate disclosed.
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">8. Prohibited Conduct</h2>
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-3">You agree not to:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">9. Intellectual Property</h2>
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">10. Disclaimers</h2>
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">11. Limitation of Liability</h2>
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 dark:text-warm-200 mb-4">12. Indemnification</h2>
            <p className="text-warm-700 dark:text-warm-300 leading-relaxed">
