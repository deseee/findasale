/**
 * Feature #45: Explorer Profile Page
 *
 * Page: /shopper/explorer-profile
 * - Display and edit explorer identity (bio, specialties, categories, keywords)
 * - View items from recent sales matching the profile
          ...
          <div className="mb-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">Explorer Profile 🗺️</h1>
                {passport && (
