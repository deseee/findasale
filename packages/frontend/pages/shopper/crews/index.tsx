          ...
          <div className="text-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 mb-8">
              ...
              <p className="text-warm-700 dark:text-warm-300 text-lg leading-relaxed mb-6">
                Crews are social groups for shoppers to coordinate hunts, share finds, and build collections together. Create or join a crew to connect with collectors who share your interests in vintage furniture, collectibles, or hidden gems at estate sales, garage sales, auctions, and more.
              </p>
