              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-warm-200 dark:divide-gray-700">
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-warm-900 dark:text-warm-100">Purchase (any item)</td>
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-3 text-warm-600 dark:text-warm-400">15 XP</td>
                    <td className="px-6 py-3 text-xs text-warm-500 dark:text-warm-400">4/month max | 2+ items + photo</td>
                    <td className="px-6 py-3 font-semibold text-purple-600 dark:text-purple-300">23 XP</td>
                  </tr>
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-warm-900 dark:text-warm-100">Seller review</td>
                    <td className="px-6 py-3 text-warm-600 dark:text-warm-400">5 XP</td>
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-warm-900 dark:text-warm-100">Appraisal selected by seller</td>
                    <td className="px-6 py-3 text-warm-600 dark:text-warm-400">20 XP</td>
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-3 text-xs text-warm-500 dark:text-warm-400">Per unique clue</td>
                    <td className="px-6 py-3 font-semibold text-purple-600 dark:text-purple-300">4 XP (+10%)</td>
                  </tr>
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-3 font-semibold text-purple-600 dark:text-purple-300">+17 XP (+10%)</td>
                  </tr>
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-3 text-warm-600 dark:text-warm-400">150 XP</td>
                    <td className="px-6 py-3 text-xs text-warm-500 dark:text-warm-400">1x/season</td>
                    <td className="px-6 py-3 font-semibold text-purple-600 dark:text-purple-300">225 XP</td>
                  </tr>
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-warm-900 dark:text-warm-100">Micro-event completion</td>
                    <td className="px-6 py-3 text-warm-600 dark:text-warm-400">75 XP</td>
                    <td className="px-6 py-3 text-xs text-warm-500 dark:text-warm-400">1x/event</td>
                    <td className="px-6 py-3 font-semibold text-purple-600 dark:text-purple-300">113 XP</td>
                  </tr>
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-warm-200 dark:border-gray-700 overflow-hidden">
                ...
                <div className="divide-y divide-warm-200 dark:divide-gray-700">
                  <div className="px-6 py-4">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <p className="font-semibold text-warm-900 dark:text-warm-100">Shopper Coupon (3 Tiers)</p>
                        <p className="text-sm text-warm-600 dark:text-warm-400">Generate a personal coupon code to use at checkout.</p>
                        <ul className="mt-1 space-y-0.5 text-xs text-warm-500 dark:text-warm-400">
                          <li>• Tier 1: 100 XP → $0.75 off $10+ (max 3/month with Hunt Pass, 2x/month standard)</li>
                          <li>• Tier 2: 200 XP → $2.00 off $25+ (max 3/month with Hunt Pass, 2x/month standard)</li>
                          <li>• Tier 3: 500 XP → $5.00 off $50+ (max 1/month all users)</li>
                        </ul>
                      </div>
                      <span className="font-bold text-purple-600 dark:text-purple-300 whitespace-nowrap ml-4">100–500 XP</span>
                    </div>
                    <p className="text-xs text-warm-500 dark:text-warm-400">Account requirement: Scout+ | Single-use, 30-day expiry | XP-only (no cash rail)</p>
                  </div>
                  <div className="px-6 py-4">
                    <div className="flex justify-between items-start mb-2">
                      <div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-warm-200 dark:border-gray-700 overflow-hidden">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-warm-200 dark:divide-gray-700">
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-sm text-warm-900 dark:text-warm-100">Walk-in visit (check-in)</td>
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-3 text-sm text-warm-900 dark:text-warm-100">QR code scan</td>
                    <td className="px-6 py-3 text-sm text-warm-600 dark:text-warm-400">5 XP<br/><span className="text-xs text-warm-500">(max 100/day)</span></td>
                    <td className="px-6 py-3 text-sm font-semibold text-purple-600 dark:text-purple-300">7.5 XP*<br/><span className="text-xs text-purple-500">(max 150/day)</span></td>
                  </tr>
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <tr className="hover:bg-warm-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-3 text-sm text-warm-600 dark:text-warm-400">20 XP</td>
                    <td className="px-6 py-3 text-sm font-semibold text-purple-600 dark:text-purple-300">30 XP</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mt-6 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4 space-y-2">
              ...
              <p className="text-xs text-purple-800 dark:text-purple-400">
                * Treasure Hunt scans with Hunt Pass receive +10% bonus on top of your rank multiplier. Example: base 3 XP × 1.1 Hunt Pass bonus = 4 XP (rounded). QR check-in scans (walk-in verification) earn 5 XP standard / 7.5 XP with Hunt Pass.
              </p>
            </div>
          </div>
