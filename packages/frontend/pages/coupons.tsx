/**
 * Unified Coupons Page — /coupons
 * Available to all logged-in users. Shows role-specific coupon mechanics:
 * - Organizers: Spend 50 XP to generate $1-off codes to share with shoppers
 * - Shoppers: Spend XP tiers to generate discounts for their own purchases
 * Both can view their active coupons.
 */
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-warm-600 dark:text-warm-400">
            Spend XP to generate discount codes. Organizers create codes to share with shoppers. Shoppers
            create codes for their own purchases.
          </p>
        </div>
        ...
        {/* Shopper Section — Your Discount Coupons */}
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-warm-900 dark:text-warm-100 mb-4">
            ...
            {(Object.entries(SHOPPER_TIERS) as [ShopperTier, typeof SHOPPER_TIERS[ShopperTier]][]).map(
              ([tier, tierData]) => {
                ...
                return (
                  <div
                    key={tier}
                    className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-warm-200 dark:border-gray-700 flex flex-col"
                  >
