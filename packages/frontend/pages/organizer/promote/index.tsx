 ...
 *
 * Allows organizers to select a sale and boost visibility to reach more buyers
 */
...
const PromoteLandingPage = () => {
  ...
  const { data: salesData, isLoading, isError, refetch } = useQuery<{ sales: Sale[] }>({
    queryKey: ['organizer-promote-sales'],
    queryFn: async () => {
  ...
  const handleSaleClick = (saleId: string) => {
    router.push(`/organizer/promote/${saleId}`);
  };
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4">
          <div className="max-w-4xl mx-auto flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Promote Sale</h1>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Select a sale to boost visibility and reach more buyers for your sale.
            </p>
          </div>
...
export default PromoteLandingPage;
