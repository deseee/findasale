/**
 * Print Kit Landing Page
 *
 * Allows organizers to select a sale and navigate to its print kit
 * (yard signs, price tags, labels, etc.)
 */
...
const PrintKitLandingPage = () => {
  ...
  const handleSaleClick = (saleId: string) => {
    router.push(`/organizer/print-kit/${saleId}`);
  };
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4">
          <div className="max-w-4xl mx-auto flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Print Kit</h1>
          </div>
        </div>
...
export default PrintKitLandingPage;
