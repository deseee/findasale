            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-gray-700">UGC Photo Moderation</span>
                </div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="flex gap-2 pt-3">
                      <button
                        ...
                        className="flex-1 px-3 py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-colors text-sm font-medium disabled:opacity-50"
                      >
                        Reject
                      </button>
                      <button
