...
const SearchPage = () => {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (filters.priceMin !== null) queryParams.set('priceMin', filters.priceMin.toString());
    if (filters.priceMax !== null) queryParams.set('priceMax', filters.priceMax.toString());
    if (filters.condition) queryParams.set('condition', filters.condition);
    if (filters.category) queryParams.set('category', filters.category);
    if (filters.saleStatus !== 'all') queryParams.set('saleStatus', filters.saleStatus);
    if (filters.sortBy !== 'recent') queryParams.set('sortBy', filters.sortBy);
    if (filters.saleType) queryParams.set('saleType', filters.saleType);
