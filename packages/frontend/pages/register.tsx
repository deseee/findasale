      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-warm-300 placeholder-warm-500 text-warm-900 focus:outline-none focus:ring-amber-500 focus:border-amber-500 focus:z-10 sm:text-sm bg-white"
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-warm-50 text-warm-500">Or sign up with</span>
          </div>
        </div>
