...
const TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Shop Mode — always-live storefront for resale shops & antique dealers; items stay live until sold, rotate between sales seamlessly',
      'Command Center — manage all sales at once',
      'Multi-user workspace — Up to 5 team members',
      'Extra members: $20/mo',
