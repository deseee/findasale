    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold text-warm-900 mb-2">Privacy Policy</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">1. Information We Collect</h2>

            <h3 className="text-lg font-semibold text-warm-700 mb-2">Account Information</h3>
            ...
            <h3 className="text-lg font-semibold text-warm-700 mb-2">Usage Data</h3>
            <p className="text-warm-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-warm-700 mb-2">Cookies and Local Storage</h3>
          ...
          {/* 2 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">2. How We Use Your Information</h2>
          ...
          {/* 3 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">3. How We Share Your Information</h2>
          ...
          {/* 4 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">4. Data Retention</h2>
            <p className="text-warm-700 leading-relaxed">
          ...
          {/* 5 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">5. Security</h2>
            <p className="text-warm-700 leading-relaxed">
          ...
          {/* 6 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">6. Your Rights and Choices</h2>
            <ul className="list-disc list-inside text-warm-700 space-y-2">
              <li>
          ...
          {/* 7 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">7. Children's Privacy</h2>
            <p className="text-warm-700 leading-relaxed">
          ...
          {/* 8 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">8. Third-Party Links</h2>
            <p className="text-warm-700 leading-relaxed">
          ...
          {/* 9 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">9. Changes to This Policy</h2>
            <p className="text-warm-700 leading-relaxed">
          ...
          {/* 10 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-warm-800 mb-4">10. Contact Us</h2>
            <p className="text-warm-700 leading-relaxed">
