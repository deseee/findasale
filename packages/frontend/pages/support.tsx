...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      'FindA.Sale charges a flat 10% platform fee on each completed purchase. If an item sells for $100, we keep $10 and you receive $90 (minus any Stripe payment processing fee, typically 2.9% + $0.30). There are no listing fees, no monthly fees on SIMPLE, and no per-photo charges. PRO and TEAMS plans reduce the fee to 8%. Auctions add one more fee, paid by the winning bidder rather than by you: a buyer premium on top of the winning bid, 5% by default and adjustable from 0% to 50% on each sale. It does not change your platform fee. On a $200 winning bid at the 10% platform rate and the standard 5% premium, the buyer pays $210, your fee is $20, and you receive $180 before Stripe processing.',
  },
  {
  ...
  },
  {
    id: 'pos-hardware-2',
    category: 'In-Person Payments',
    question: 'Which card readers are compatible with FindA.Sale?',
    answer:
      'FindA.Sale\'s web-based POS is compatible with the Stripe Reader S700 and Stripe Reader S710 only. Other Stripe readers (including mobile Bluetooth readers) require a native app and are not supported. The S710 is worth considering if your sale venue has unreliable Wi-Fi, since it includes a cellular connection. Both readers are available at stripe.com/terminal.',
  },
  {
    id: 'integrations-1',
