...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      'Card-reader hardware support is currently being updated, so we can\'t confirm compatible readers right now. In the meantime, your POS page supports cash, QR/link payments, Venmo, and Zelle for in-person sales.',
  },
  {
    id: 'integrations-1',
