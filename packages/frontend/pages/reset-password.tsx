          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            ...
            {success ? (
              <div className="text-center">
                <div className="mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded text-green-800 dark:text-green-200 dark:text-green-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="password" className="block text-sm font-medium text-warm-700 dark:text-warm-300 mb-1">
                    New Password
                  </label>
                  <input
                    type="password"
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-medium text-warm-700 dark:text-warm-300 mb-1">
                    Confirm Password
                  </label>
                  <input
                    type="password"
