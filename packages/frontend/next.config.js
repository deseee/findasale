...
const nextConfig = {
  ...
  images: {
    domains: ['res.cloudinary.com', 'picsum.photos', 'api.qrserver.com', 'i.ebayimg.com', 'images.unsplash.com'],
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://res.cloudinary.com https://picsum.photos https://images.unsplash.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://maps.googleapis.com https://unpkg.com https://raw.githubusercontent.com https://api.qrserver.com https://i.ebayimg.com",
