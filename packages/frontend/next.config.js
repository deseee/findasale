        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://res.cloudinary.com https://*.cloudinary.com https://picsum.photos https://images.unsplash.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://maps.googleapis.com https://unpkg.com https://raw.githubusercontent.com https://api.qrserver.com https://i.ebayimg.com https://picturescdn.estatesales.net https://findasale-image-proxy.findasale.workers.dev https://www.googletagmanager.com https://www.google-analytics.com https://i.discogs.com https://img.discogs.com", // 2026-09-05 weekly audit M1: GA4/GTM measurement-pixel requests were blocked, throwing a CSP console error on every single page load (script-src/connect-src already allowed these domains, img-src did not)
              // media-src: missing entirely meant <video>/<audio> fell back to default-src 'self',
