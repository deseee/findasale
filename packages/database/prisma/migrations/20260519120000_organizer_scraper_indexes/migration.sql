...
CREATE INDEX IF NOT EXISTS "Organizer_isClaimed_idx" ON "public"."Organizer"("isClaimed");
CREATE INDEX IF NOT EXISTS "Organizer_isUnmanagedListing_idx" ON "public"."Organizer"("isUnmanagedListing");
