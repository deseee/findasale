...
import { getExtensionItems, markItemListed, markItemRemoved, getPendingRemovals } from '../controllers/extensionController';
...
router.get('/pending-removals', authenticate, requireOrganizer, getPendingRemovals);
