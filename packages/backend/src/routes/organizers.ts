...
router.post('/me/ebay-sync-issues/retry', authenticate, retryEbaySync);
...
router.get('/me', authenticate, checkTierLapse, async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.json({
      ...
      twitterUrl: (organizer as any).twitterUrl || null,
      tiktokUrl: (organizer as any).tiktokUrl || null,
      youtubeUrl: (organizer as any).youtubeUrl || null,
      pinterestUrl: (organizer as any).pinterestUrl || null,
