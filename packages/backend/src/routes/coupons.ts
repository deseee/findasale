...
router.post('/generate', authenticate, requireOrganizer, couponRateLimiter, generateXpSinkCoupon);
// Phase 2b: XP sink for shoppers — 3 tiers (100/150/500 XP), generates personal coupon
router.post('/generate-from-xp', authenticate, couponRateLimiter, generateShopperCoupon);
