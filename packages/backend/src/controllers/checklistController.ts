...
const ALL_TASKS: TaskDefinition[] = [
  ...
  { id: 'pub_published', stage: 'Cataloging', label: 'Sale published', isAuto: true, autoCheck: (d) => d.sale.status === 'PUBLISHED' || d.sale.status === 'LIVE', link: '/organizer/edit-sale/{saleId}' },
  { id: 'pub_social', stage: 'Pre-Sale', label: 'Sale shared on social media', isAuto: false, link: '/organizer/promote/{saleId}' },
  { id: 'live_internet', stage: 'Pre-Sale', label: 'Internet connection tested', isAuto: false },
  { id: 'pub_preview', stage: 'Pre-Sale', label: 'Sale previewed on mobile', isAuto: false, link: '/organizer/edit-sale/{saleId}' },
  { id: 'pre_online_checkout', stage: 'Live', label: 'Online checkout tested', isAuto: false, link: '/organizer/plan/{saleId}' },
  { id: 'pre_auction_checkout', stage: 'Live', label: 'Auction checkout tested', isAuto: false, link: '/organizer/plan/{saleId}' },
