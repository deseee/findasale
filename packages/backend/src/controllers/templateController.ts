...
const DEFAULT_TEMPLATES = [
  ...
  { title: 'Item Sold', body: 'We\'re sorry, that item has already been sold. We do have many other great items, and we hope you\'ll still stop by!', category: 'availability' },
];
