...
// createCheckoutSession (dead Stripe subscription-checkout endpoint, #23 Pricing page) removed 2026-09-20 -- zero live frontend callers, Stripe's platform account is permanently closed. Patrick's decision: "theres no stripe at all get rid of it".

// createAlaCarteCheckout (#132, $9.99 dead Stripe ala-carte checkout) removed 2026-09-20 -- already orphaned/unrouted (frontend migrated to Square's createAlaCarteSquarePayment, commit ccdeb03b7). Patrick's decision: "theres no stripe at all get rid of it".
