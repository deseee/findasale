 ...
 *      This file was named `auctionClosing.integration.ts` -- no `.test.ts` suffix -- so jest never collected it.
 ...
 *
 * Fixed by renaming to `auctionClosing.integration.test.ts` and converting the vitest API to Jest:
