 ...
 *      This file was named `auth.integration.ts` -- no `.test.ts` suffix -- so jest never collected it.
 ...
 *
 * Fixed by renaming to `auth.integration.test.ts` and converting the vitest API to Jest:
