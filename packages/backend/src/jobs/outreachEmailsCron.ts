...
const TEMPLATES: Record<string, Record<string, { subject: string; html: string }>> = {
  ...
  WARM: {
    ...
    touch2: {
      ...
      html: '<p>Hi [Business Name],</p><p>Quick thought on what FindA.Sale changes for a business like yours.</p><p>Your shoppers are searching by item, not by sale. Someone wants a mid-century dresser, a Snap-on socket set, a Pyrex set in good shape. They search the item. Most secondary-market platforms surface big retailers and individual listings — not organizer inventory.</p><p>Your storefront puts your inventory in front of those searches.</p><p>Your storefront:<br><a href="[preview link]">[preview link]</a></p><p>Walkthrough: <a href="[video link]?src=outreach-warm-2">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
    touch3: {
      subject: 'Two reasons you haven\'t claimed yet',
      html: '<p>Hi [Business Name],</p><p>You looked at the email — didn\'t click through. Probably one of two reasons.</p><p>Either claiming a storefront sounds like work, or you don\'t know what shows up there until you do.</p><p>It\'s neither. Your storefront is already populated with the public info we found on your business. Claiming it means clicking one link, confirming your email, and adding items when you have time.</p><p>Claim in 30 seconds:<br><a href="[preview link]">[preview link]</a></p><p>Or see it first: <a href="[video link]?src=outreach-warm-3">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
    touch4: {
      subject: 'Your storefront stays live',
      html: '<p>Hi [Business Name],</p><p>Last note.</p><p>[Business Name]\'s storefront stays live. Nothing expires, nothing gets reassigned. If listing online makes sense for a future sale, you can claim it then.</p><p>Storefront:<br><a href="[preview link]">[preview link]</a></p><p>Walkthrough: <a href="[video link]?src=outreach-warm-4">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
  },
  HOT: {
    touch1: {
      subject: '[Business Name] — built for the volume you run',
      html: '<p>Hi [Business Name],</p><p>We\'ve been talking to organizers in [state] running multiple sale events a month — licensed auctioneers, professional liquidators, consignment shops moving real volume.</p><p>The throughput tools we built for that group:</p><p>• RapidFire phone capture — 100 items in 20 minutes, tagged and priced as you shoot<br>• Staff accounts — delegate photo, pricing, and listing review work<br>• Printable inventory sheets for sale day<br>• Inventory export to eBay, Shopify, or your own system anytime</p><p>Your storefront is built and waiting:<br><a href="[preview link]">[preview link]</a></p><p>45-second walkthrough: <a href="[video link]?src=outreach-hot-1">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
    touch2: {
      subject: 'Why repeat buyers stop showing up',
      html: '<p>Hi [Business Name],</p><p>Quick thought on what a persistent storefront changes for a high-volume operation.</p><p>Right now, every sale you run is its own discovery problem. New flyers, new posts, new Facebook events, new email to your list. Inventory from your last sale is invisible the day after.</p><p>Your storefront keeps everything you\'ve ever listed discoverable. Shoppers searching for a specific item find it whether the sale was last week or last month. Repeat buyers come back to one place.</p><p>Storefront:<br><a href="[preview link]">[preview link]</a></p><p>Walkthrough: <a href="[video link]?src=outreach-hot-2">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
    touch3: {
      subject: 'Runs alongside what you already do',
      html: '<p>Hi [Business Name],</p><p>Two emails, two opens, no clicks. Fair guess: you have a system that works and adding another platform sounds like learning curve you don\'t need.</p><p>FindA.Sale isn\'t replacing what you do. It runs alongside. Photos taken on your phone push into your storefront automatically. Sale-day exports go to spreadsheets, eBay, Shopify, or print. Your team can use it without onboarding training.</p><p>See the workflow in 45 seconds: <a href="[video link]?src=outreach-hot-3">finda.sale/video</a></p><p>Your storefront:<br><a href="[preview link]">[preview link]</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
    touch4: {
      subject: 'Here when a sale comes up that needs it',
      html: '<p>Hi [Business Name],</p><p>Last note from us.</p><p>You run a serious operation. We built FindA.Sale for organizers exactly at your volume — and we\'ll be here when a sale comes up where a public, persistent inventory page helps you move more.</p><p>Storefront:<br><a href="[preview link]">[preview link]</a></p><p>Walkthrough: <a href="[video link]?src=outreach-hot-4">finda.sale/video</a></p><p>— The FindA.Sale Team<br><a href="[unsubscribe link]">Unsubscribe</a> · [physical address]</p>',
    },
  },
};
